...
class PixDLMForCausalLM(LlavaLlamaForCausalLM):
    def __init__(
        ...
        **kwargs,
        ...
        print("pixdlm.freeze_vision:", self.freeze_vision)        
        ...
        if hasattr(self, "local_rank") and getattr(self, "local_rank", 0) == 0:
            print(f"[DEBUG] three_level_multi_scale_decoder: kwargs={kwargs_value}, config={config_value}, final={self.three_level_multi_scale_decoder}")
